              ...
              <div class="col-md-5 col-lg-3 col-xl-3">
                <div class="view zoom overlay z-depth-1 rounded mb-3 mb-md-0">
                  <img class="card-img-top"
                       :src="c.produktImageURL" alt="Sample" height="240" width=auto>
                </div>
              </div>
              <div class="col-md-7 col-lg-9 col-xl-9">
                <div>
                  ...
                  <div class="d-flex justify-content-between align-items-center">
                    <p class="mb-0"><span><strong id="summary">Preis: {{ c.produktPreis }}</strong></span></p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="pt-4">
            ...
            <ul class="list-group list-group-flush">
              ...
              <li class="list-group-item d-flex justify-content-between align-items-center border-0 px-0 mb-3">
                ...
                <span><strong>{{ sumWithTax }} Euro</strong></span>
              </li>
            </ul>
            <button type="button" class="btn btn-primary btn-block">Jetzt kaufen</button>
          </div>
        </div>
      </div>
    </div>
